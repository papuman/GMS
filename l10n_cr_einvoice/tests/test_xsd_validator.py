...
class TestXSDValidator(TransactionCase):
    ...
    def test_validator_exists(self):
        ...
        # l10n_cr.xsd.validator is an AbstractModel, so it has no records
        # We verify it exists by checking we can call its methods
        self.assertIsNotNone(self.validator, "XSD validator model should exist")
        self.assertTrue(hasattr(self.validator, 'validate_xml'), "Validator should have validate_xml method")
