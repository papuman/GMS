...
## 🎯 Goal: Achieve Feature Parity in 4 Weeks
...
def action_void_invoice(self):
    ...
    2. Create matching Nota de Crédito (100% credit)
...
**Acceptance Criteria:**
- ✅ Button appears on accepted invoices only
- ✅ Wizard prompts for void reason
- ✅ Credit note auto-generated with 100% amount
- ✅ Credit note submitted to Hacienda
...
**Priority:** 🔴 CRITICAL (Error prevention)
**Effort:** 4-6 hours
**Owner:** Dev team
...
```
Before:
[Create Invoice] → [Submit to Hacienda] → Done

After:
[Create Invoice] → [Preview] → [Confirm] → [Submit to Hacienda] → Done
                       ↓
                   [Cancel] → Edit invoice
```

**Acceptance Criteria:**
- ✅ Preview wizard shows PDF
- ✅ Shows customer name, amount, tax clearly
- ✅ [Cancel] returns to invoice editing
- ✅ [Confirm] submits to Hacienda
- ✅ Can be skipped with checkbox: "Don't show again"
...
def _compute_status_badge(self):
    for rec in self:
        if rec.hacienda_state == 'accepted':
            rec.status_badge = '✓ Aprobado por Hacienda'
        elif rec.hacienda_state == 'rejected':
            rec.status_badge = '✗ Rechazado por Hacienda'
        elif rec.hacienda_state == 'pending':
            rec.status_badge = '⏳ Pendiente aprobación'
        else:
            rec.status_badge = '⚪ Borrador'
```
    ...
    <t t-call="web.html_container">
        <t t-foreach="docs" t-as="o">
            <div class="page">
                ...
                <p>Período: <span t-esc="date_from"/> - <span t-esc="date_to"/></p>
...
- Map sale.order.line → einvoice line items

---

### Task 5.2: Nota de Débito Support
**Effort:** 4-6 hours
...
### Must-Have (Week 1-4)
- [x] Invoice void/cancel workflow ← **BLOCKING**
- [x] Preview before Hacienda submission ← **BLOCKING**
- [x] CR tax reports (D-104, D-101, D-151) ← **BLOCKING**
...
### Week 1
- ✅ Void workflow implemented
- ✅ Preview wizard functional
- ✅ Tax reports research complete

### Week 2
- ✅ Clone function working
- ✅ Tags system deployed
...
### Week 4
- ✅ All 3 tax reports functional
- ✅ v1.0 ready for beta testing
...
### Today
1. ✅ Read full analysis (HULIPRACTICE-COMPETITIVE-ANALYSIS.md)
2. ✅ Review this action plan
